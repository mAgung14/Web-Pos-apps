            ...
            <div id="flFormsGrid" class="col-lg-12 layout-spacing mt-4">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area p-4">
                        <form action="{{ url('/variant/edit/') . $var->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row mb-4">
                                <div class="form-group col-md-6">
                                    <label for="lFullName">Name</label>
                                    <input type="text" name="name" class="form-control" id="lFullName" placeholder="Name" value="{{ $var->name }}" required >
                                </div>
